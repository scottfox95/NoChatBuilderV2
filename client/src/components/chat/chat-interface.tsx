      ...
      if (isPreview) {
        ...
        return {
          message: {
            ...
            sessionId: "preview",
            isUser: false,
            content: "This is a preview response based on your configuration. In the actual chatbot, this would be generated by the AI using your system prompt and other settings.",
            timestamp: new Date(),
          },
          sessionId: "preview"
        } as ChatResponse;
